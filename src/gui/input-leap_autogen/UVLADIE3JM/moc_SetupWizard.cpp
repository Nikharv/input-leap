...
template <> constexpr inline auto SetupWizard::qt_create_metaobjectdata<qt_meta_tag_ZN11SetupWizardE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        "SetupWizard",
        "on_m_pComboLanguage_currentIndexChanged",
        "",
        "index"
    };

    QtMocHelpers::UintData qt_methods {
        // Slot 'on_m_pComboLanguage_currentIndexChanged'
...
void SetupWizard::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->on_m_pComboLanguage_currentIndexChanged((*reinterpret_cast<std::add_pointer_t<int>>(_a[1]))); break;
        default: ;
        }
    }
}
