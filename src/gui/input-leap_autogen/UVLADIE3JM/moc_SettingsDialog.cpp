...
void SettingsDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (SettingsDialog::*)(QString )>(_a, &SettingsDialog::requestLanguageChange, 0))
            return;
    }
}
...
// SIGNAL 0
void SettingsDialog::requestLanguageChange(QString _t1)
{
