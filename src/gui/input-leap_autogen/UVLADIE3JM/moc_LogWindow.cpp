...
template <> constexpr inline auto LogWindow::qt_create_metaobjectdata<qt_meta_tag_ZN9LogWindowE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        "LogWindow",
        "on_m_pButtonHide_clicked",
        "",
        "on_m_pButtonClearLog_clicked"
    };

    QtMocHelpers::UintData qt_methods {
        // Slot 'on_m_pButtonHide_clicked'
        QtMocHelpers::SlotData<void()>(1, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_m_pButtonClearLog_clicked'
...
void LogWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->on_m_pButtonHide_clicked(); break;
        case 1: _t->on_m_pButtonClearLog_clicked(); break;
        default: ;
        }
    }
    (void)_a;
